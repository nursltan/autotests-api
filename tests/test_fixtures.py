...
class TestUserFlow:
    def test_user_can_login(self,settings, user, users_client, sent_anaytincs_data):
        ...
    
    def test_user_create_course(self,settings, user, users_client, sent_anaytincs_data):
        ...
    
class TestAccountFlow:
    def test_user_account(self,settings, user, users_client, sent_anaytincs_data):
        ...

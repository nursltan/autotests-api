...
def assert_create_user_response(request: CreateUserRequestSchema,response: CreateUserResponseSchema):
    ...
    assert_equal(response.user.last_name,request.last_name,name='middle_name')
    assert_equal(response.user.first_name,request.first_name,name='first_name')
    assert_equal(response.user.middle_name,request.middle_name,name='first_name')
...
def assert_user(actual: UserSchema, expected: UserSchema):
    ...
    assert_equal(actual.last_name, expected.last_name,name='middle_name')
    assert_equal(actual.first_name, expected.first_name,name='first_name')
    assert_equal(actual.middle_name, expected.middle_name,name='first_name')

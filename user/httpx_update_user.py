...
update_user_response = httpx.patch(f'http://localhost:8000/api/v1/users/{create_user_data['user']['id']}',headers=update_user_headers,json=update_user_payload)

update_user_data = update_user_response.json()

print('Данные обновления: ',update_user_data)
print('Статус код обновления: ', update_user_response.status_code)